...
class ActionList(RequestHandler):
  ...
  def get(self):
    ...
    if len(items) > 0:
      self.render('priv/turkadmin/action_list.html', {'items': items})
    else:
      self.render('priv/turkadmin/action_list_empty.html', {})
...
class ActionView(RequestHandler):
  ...
  def get(self):
    if self.action.confirmed:
      self.render('priv/turkadmin/action_results.html', {
        'action': self.action
      , 'operations': [self.item(operation) for operation in action_operations(self.action)]
      })
    else:
      self.render('priv/turkadmin/action_preview.html', {
        'action': self.action
  ...
  def post(self):
    ...
    for operation in action_operations(self.action):
      taskqueue.add(url='/turkadmin/operation/task', params={'key': operation.key()})
...
class OperationView(RequestHandler):
  ...
  def get(self):
    ...
    self.render('priv/turkadmin/operation_view.html', {
...
class AssignmentApprovalForm(RequestHandler):
  def get(self):
    self.render('priv/turkadmin/assignment_approval_form.html', {
      'url': self.request.url
    })
...
class AssignmentRejectionForm(RequestHandler):
  def get(self):
    self.render('priv/turkadmin/assignment_rejection_form.html', {
      'url': self.request.url
    })
...
class WorkerBonusForm(RequestHandler):
  def get(self):
    self.render('priv/turkadmin/worker_bonus_form.html', {
      'url': self.request.url
    })
...
class WorkerNotificationForm(RequestHandler):
  def get(self):
    self.render('priv/turkadmin/worker_notification_form.html', {
      'url': self.request.url
    })
...
def handlers():
  return [
    ('/turkadmin', ActionList)
  , ('/turkadmin/action', ActionView)
  , ('/turkadmin/operation', OperationView)
  , ('/turkadmin/operation/task', OperationTask)
  , ('/turkadmin/assignment/approval/form', AssignmentApprovalForm)
  , ('/turkadmin/assignment/rejection/form', AssignmentRejectionForm)
  , ('/turkadmin/worker/bonus/form', WorkerBonusForm)
  , ('/turkadmin/worker/notification/form', WorkerNotificationForm)
  ]
